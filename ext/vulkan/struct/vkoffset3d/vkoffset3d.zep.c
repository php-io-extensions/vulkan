...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkOffset3D, VkOffset3D, vulkan, struct_vkoffset3d_vkoffset3d, vulkan_struct_vkoffset3d_vkoffset3d_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkOffset3D_VkOffset3D, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkoffset3d_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkOffset3D_VkOffset3D, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkoffset3d_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkOffset3D_VkOffset3D, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkoffset3d_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkOffset3D_VkOffset3D, size)
{
	...
	RETURN_LONG(phpvk_struct_vkoffset3d_size());
}
