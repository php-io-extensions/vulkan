...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkSemaphoreSubmitInfo, VkSemaphoreSubmitInfo, vulkan, struct_vksemaphoresubmitinfo_vksemaphoresubmitinfo, vulkan_struct_vksemaphoresubmitinfo_vksemaphoresubmitinfo_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkSemaphoreSubmitInfo_VkSemaphoreSubmitInfo, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vksemaphoresubmitinfo_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkSemaphoreSubmitInfo_VkSemaphoreSubmitInfo, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vksemaphoresubmitinfo_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkSemaphoreSubmitInfo_VkSemaphoreSubmitInfo, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vksemaphoresubmitinfo_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkSemaphoreSubmitInfo_VkSemaphoreSubmitInfo, size)
{
	...
	RETURN_LONG(phpvk_struct_vksemaphoresubmitinfo_size());
}
