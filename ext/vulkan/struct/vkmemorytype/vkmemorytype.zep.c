...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkMemoryType, VkMemoryType, vulkan, struct_vkmemorytype_vkmemorytype, vulkan_struct_vkmemorytype_vkmemorytype_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkMemoryType_VkMemoryType, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkmemorytype_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkMemoryType_VkMemoryType, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkmemorytype_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkMemoryType_VkMemoryType, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkmemorytype_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkMemoryType_VkMemoryType, size)
{
	...
	RETURN_LONG(phpvk_struct_vkmemorytype_size());
}
