...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkPipelineCacheCreateInfo, VkPipelineCacheCreateInfo, vulkan, struct_vkpipelinecachecreateinfo_vkpipelinecachecreateinfo, vulkan_struct_vkpipelinecachecreateinfo_vkpipelinecachecreateinfo_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkPipelineCacheCreateInfo_VkPipelineCacheCreateInfo, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkpipelinecachecreateinfo_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkPipelineCacheCreateInfo_VkPipelineCacheCreateInfo, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkpipelinecachecreateinfo_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkPipelineCacheCreateInfo_VkPipelineCacheCreateInfo, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkpipelinecachecreateinfo_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkPipelineCacheCreateInfo_VkPipelineCacheCreateInfo, size)
{
	...
	RETURN_LONG(phpvk_struct_vkpipelinecachecreateinfo_size());
}
