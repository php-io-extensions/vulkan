...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkRenderingInfo, VkRenderingInfo, vulkan, struct_vkrenderinginfo_vkrenderinginfo, vulkan_struct_vkrenderinginfo_vkrenderinginfo_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkRenderingInfo_VkRenderingInfo, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkrenderinginfo_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkRenderingInfo_VkRenderingInfo, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkrenderinginfo_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkRenderingInfo_VkRenderingInfo, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkrenderinginfo_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkRenderingInfo_VkRenderingInfo, size)
{
	...
	RETURN_LONG(phpvk_struct_vkrenderinginfo_size());
}
