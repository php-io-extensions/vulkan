...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkRenderingAttachmentInfo, VkRenderingAttachmentInfo, vulkan, struct_vkrenderingattachmentinfo_vkrenderingattachmentinfo, vulkan_struct_vkrenderingattachmentinfo_vkrenderingattachmentinfo_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkRenderingAttachmentInfo_VkRenderingAttachmentInfo, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkrenderingattachmentinfo_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkRenderingAttachmentInfo_VkRenderingAttachmentInfo, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkrenderingattachmentinfo_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkRenderingAttachmentInfo_VkRenderingAttachmentInfo, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkrenderingattachmentinfo_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkRenderingAttachmentInfo_VkRenderingAttachmentInfo, size)
{
	...
	RETURN_LONG(phpvk_struct_vkrenderingattachmentinfo_size());
}
