...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkSubresourceLayout, VkSubresourceLayout, vulkan, struct_vksubresourcelayout_vksubresourcelayout, vulkan_struct_vksubresourcelayout_vksubresourcelayout_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkSubresourceLayout_VkSubresourceLayout, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vksubresourcelayout_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkSubresourceLayout_VkSubresourceLayout, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vksubresourcelayout_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkSubresourceLayout_VkSubresourceLayout, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vksubresourcelayout_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkSubresourceLayout_VkSubresourceLayout, size)
{
	...
	RETURN_LONG(phpvk_struct_vksubresourcelayout_size());
}
