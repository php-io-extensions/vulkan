...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkExtent3D, VkExtent3D, vulkan, struct_vkextent3d_vkextent3d, vulkan_struct_vkextent3d_vkextent3d_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkExtent3D_VkExtent3D, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkextent3d_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkExtent3D_VkExtent3D, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkextent3d_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkExtent3D_VkExtent3D, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkextent3d_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkExtent3D_VkExtent3D, size)
{
	...
	RETURN_LONG(phpvk_struct_vkextent3d_size());
}
