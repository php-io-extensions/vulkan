...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkImageBlit, VkImageBlit, vulkan, struct_vkimageblit_vkimageblit, vulkan_struct_vkimageblit_vkimageblit_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkImageBlit_VkImageBlit, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkimageblit_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkImageBlit_VkImageBlit, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkimageblit_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkImageBlit_VkImageBlit, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkimageblit_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkImageBlit_VkImageBlit, size)
{
	...
	RETURN_LONG(phpvk_struct_vkimageblit_size());
}
