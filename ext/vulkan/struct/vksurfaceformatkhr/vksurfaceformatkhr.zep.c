...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkSurfaceFormatKHR, VkSurfaceFormatKHR, vulkan, struct_vksurfaceformatkhr_vksurfaceformatkhr, vulkan_struct_vksurfaceformatkhr_vksurfaceformatkhr_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkSurfaceFormatKHR_VkSurfaceFormatKHR, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vksurfaceformatkhr_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkSurfaceFormatKHR_VkSurfaceFormatKHR, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vksurfaceformatkhr_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkSurfaceFormatKHR_VkSurfaceFormatKHR, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vksurfaceformatkhr_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkSurfaceFormatKHR_VkSurfaceFormatKHR, size)
{
	...
	RETURN_LONG(phpvk_struct_vksurfaceformatkhr_size());
}
