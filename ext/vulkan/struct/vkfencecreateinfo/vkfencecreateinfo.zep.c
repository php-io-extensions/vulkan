...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkFenceCreateInfo, VkFenceCreateInfo, vulkan, struct_vkfencecreateinfo_vkfencecreateinfo, vulkan_struct_vkfencecreateinfo_vkfencecreateinfo_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkFenceCreateInfo_VkFenceCreateInfo, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkfencecreateinfo_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkFenceCreateInfo_VkFenceCreateInfo, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkfencecreateinfo_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkFenceCreateInfo_VkFenceCreateInfo, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkfencecreateinfo_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkFenceCreateInfo_VkFenceCreateInfo, size)
{
	...
	RETURN_LONG(phpvk_struct_vkfencecreateinfo_size());
}
