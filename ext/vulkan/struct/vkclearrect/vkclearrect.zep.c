...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkClearRect, VkClearRect, vulkan, struct_vkclearrect_vkclearrect, vulkan_struct_vkclearrect_vkclearrect_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkClearRect_VkClearRect, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkclearrect_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkClearRect_VkClearRect, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkclearrect_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkClearRect_VkClearRect, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkclearrect_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkClearRect_VkClearRect, size)
{
	...
	RETURN_LONG(phpvk_struct_vkclearrect_size());
}
