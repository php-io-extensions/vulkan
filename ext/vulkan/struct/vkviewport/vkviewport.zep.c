...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkViewport, VkViewport, vulkan, struct_vkviewport_vkviewport, vulkan_struct_vkviewport_vkviewport_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkViewport_VkViewport, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkviewport_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkViewport_VkViewport, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkviewport_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkViewport_VkViewport, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkviewport_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkViewport_VkViewport, size)
{
	...
	RETURN_LONG(phpvk_struct_vkviewport_size());
}
