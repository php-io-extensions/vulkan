...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkImageCopy, VkImageCopy, vulkan, struct_vkimagecopy_vkimagecopy, vulkan_struct_vkimagecopy_vkimagecopy_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkImageCopy_VkImageCopy, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkimagecopy_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkImageCopy_VkImageCopy, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkimagecopy_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkImageCopy_VkImageCopy, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkimagecopy_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkImageCopy_VkImageCopy, size)
{
	...
	RETURN_LONG(phpvk_struct_vkimagecopy_size());
}
