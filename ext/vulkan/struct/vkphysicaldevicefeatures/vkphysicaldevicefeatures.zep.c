...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkPhysicalDeviceFeatures, VkPhysicalDeviceFeatures, vulkan, struct_vkphysicaldevicefeatures_vkphysicaldevicefeatures, vulkan_struct_vkphysicaldevicefeatures_vkphysicaldevicefeatures_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkPhysicalDeviceFeatures_VkPhysicalDeviceFeatures, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkphysicaldevicefeatures_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkPhysicalDeviceFeatures_VkPhysicalDeviceFeatures, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkphysicaldevicefeatures_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkPhysicalDeviceFeatures_VkPhysicalDeviceFeatures, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkphysicaldevicefeatures_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkPhysicalDeviceFeatures_VkPhysicalDeviceFeatures, size)
{
	...
	RETURN_LONG(phpvk_struct_vkphysicaldevicefeatures_size());
}
