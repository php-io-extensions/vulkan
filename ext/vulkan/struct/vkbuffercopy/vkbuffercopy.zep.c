...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkBufferCopy, VkBufferCopy, vulkan, struct_vkbuffercopy_vkbuffercopy, vulkan_struct_vkbuffercopy_vkbuffercopy_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkBufferCopy_VkBufferCopy, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkbuffercopy_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkBufferCopy_VkBufferCopy, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkbuffercopy_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkBufferCopy_VkBufferCopy, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkbuffercopy_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkBufferCopy_VkBufferCopy, size)
{
	...
	RETURN_LONG(phpvk_struct_vkbuffercopy_size());
}
