...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkMemoryHeap, VkMemoryHeap, vulkan, struct_vkmemoryheap_vkmemoryheap, vulkan_struct_vkmemoryheap_vkmemoryheap_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkMemoryHeap_VkMemoryHeap, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkmemoryheap_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkMemoryHeap_VkMemoryHeap, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkmemoryheap_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkMemoryHeap_VkMemoryHeap, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkmemoryheap_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkMemoryHeap_VkMemoryHeap, size)
{
	...
	RETURN_LONG(phpvk_struct_vkmemoryheap_size());
}
