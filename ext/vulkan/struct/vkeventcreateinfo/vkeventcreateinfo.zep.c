...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkEventCreateInfo, VkEventCreateInfo, vulkan, struct_vkeventcreateinfo_vkeventcreateinfo, vulkan_struct_vkeventcreateinfo_vkeventcreateinfo_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkEventCreateInfo_VkEventCreateInfo, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkeventcreateinfo_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkEventCreateInfo_VkEventCreateInfo, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkeventcreateinfo_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkEventCreateInfo_VkEventCreateInfo, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkeventcreateinfo_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkEventCreateInfo_VkEventCreateInfo, size)
{
	...
	RETURN_LONG(phpvk_struct_vkeventcreateinfo_size());
}
