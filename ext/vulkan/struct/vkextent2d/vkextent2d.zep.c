...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkExtent2D, VkExtent2D, vulkan, struct_vkextent2d_vkextent2d, vulkan_struct_vkextent2d_vkextent2d_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkExtent2D_VkExtent2D, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkextent2d_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkExtent2D_VkExtent2D, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkextent2d_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkExtent2D_VkExtent2D, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkextent2d_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkExtent2D_VkExtent2D, size)
{
	...
	RETURN_LONG(phpvk_struct_vkextent2d_size());
}
