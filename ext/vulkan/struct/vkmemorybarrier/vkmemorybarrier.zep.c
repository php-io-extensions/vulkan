...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkMemoryBarrier, VkMemoryBarrier, vulkan, struct_vkmemorybarrier_vkmemorybarrier, vulkan_struct_vkmemorybarrier_vkmemorybarrier_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkMemoryBarrier_VkMemoryBarrier, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkmemorybarrier_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkMemoryBarrier_VkMemoryBarrier, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkmemorybarrier_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkMemoryBarrier_VkMemoryBarrier, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkmemorybarrier_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkMemoryBarrier_VkMemoryBarrier, size)
{
	...
	RETURN_LONG(phpvk_struct_vkmemorybarrier_size());
}
