...
{
	ZEPHIR_REGISTER_CLASS(Vulkan\\Struct\\VkImageResolve, VkImageResolve, vulkan, struct_vkimageresolve_vkimageresolve, vulkan_struct_vkimageresolve_vkimageresolve_method_entry, 0);
...
PHP_METHOD(Vulkan_Struct_VkImageResolve_VkImageResolve, pack)
{
	...
	RETURN_MM_LONG(phpvk_struct_vkimageresolve_pack(&members));
}
...
PHP_METHOD(Vulkan_Struct_VkImageResolve_VkImageResolve, packInto)
{
	...
	zephir_get_arrval(&members, members_param);
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkimageresolve_packinto(&_0, &members);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Vulkan_Struct_VkImageResolve_VkImageResolve, unpack)
{
	...
	ZVAL_LONG(&_0, ptr);
	phpvk_struct_vkimageresolve_unpack(&result, &_0);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(Vulkan_Struct_VkImageResolve_VkImageResolve, size)
{
	...
	RETURN_LONG(phpvk_struct_vkimageresolve_size());
}
